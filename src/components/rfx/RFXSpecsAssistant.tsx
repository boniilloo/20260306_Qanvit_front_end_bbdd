...
const RFXSpecsAssistant: React.FC = () => {
  const content = (
    <>
      ...
      <p>Finally, at the bottom you'll find a button to generate a PDF with all the information provided. You can even customize it with your company's colors and logos in the <span className="font-semibold text-[#80c8f0]">PDF Customization</span> section.</p>
    </>
  );
