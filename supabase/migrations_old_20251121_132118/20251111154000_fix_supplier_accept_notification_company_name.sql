-- Fix: use existing sources for company name (no column public.company.name)
-- Prefer billing info company_name; fallback to latest active company_revision.nombre_empresa
