-- Add debug logging to create_notifications_on_rfx_announcement function
-- This will help us understand why notifications are not being created
...
begin
  ...
  raise notice 'Notifications created: %', v_company_count;
...
'Creates in-app and email notifications to all companies related to an RFX when an announcement is posted (SECURITY DEFINER). Includes debug logging.';
