        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              <div className="text-sm font-semibold text-[#22183a] truncate">{propuesta.empresa}</div>
              {propuesta.producto && (
                <div className="text-xs text-gray-600 truncate">{propuesta.producto}</div>
              )}
            </div>
            <div className="text-right shrink-0">
              <div className="text-base font-bold text-[#22183a]">{mainPercent}%</div>
          ...
          <div className="mt-2 flex items-center justify-end gap-1 text-xs text-sky-700">
            <span>Qanvit Match reasoning</span>
