  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 mb-8">
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold text-[#22183a] flex items-center gap-2">
          <Zap className="w-4 h-4 text-[#f4a9aa]" />
          ...
          <div key={index} className="flex items-center gap-3">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
              index < currentStep 
                ...
                : index === currentStep 
                  ? 'bg-[#f4a9aa] text-white animate-pulse' 
            ...
            <span className={`text-sm transition-colors duration-300 ${
              index <= currentStep ? 'text-[#22183a] font-medium' : 'text-gray-400'
            }`}>
              {step}
            </span>
          </div>
      ...
      <div className="mt-4 bg-gray-100 rounded-full h-2 overflow-hidden">
        <div 
          className="h-full bg-gradient-to-r from-[#f4a9aa] to-[#f4a9aa] transition-all duration-500 ease-out"
