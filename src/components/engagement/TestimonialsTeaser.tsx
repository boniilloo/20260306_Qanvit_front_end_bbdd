  ...
  return (
    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
      <div className="text-center mb-6">
        <motion.div
          className="w-16 h-16 bg-gradient-to-br from-[#80c8f0] to-[#7de19a] rounded-full flex items-center justify-center mx-auto mb-4"
        ...
        <h2 className="text-xl font-bold font-intro text-[#1b2c4a] mb-2">
          Success Stories
        </h2>
      ...
      <div className="space-y-4 mb-6">
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <blockquote className="text-sm text-[#1b2c4a] font-inter mb-2 italic">
              "{testimonial.quote}"
            </blockquote>
      ...
      {/* Stats highlight */}
      <motion.div
        className="bg-gradient-to-r from-[#80c8f0]/10 to-[#7de19a]/10 rounded-xl p-4 mb-6 border border-[#80c8f0]/20"
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ delay: 0.5 }}
      >
        <div className="text-center">
          <div className="text-2xl font-bold text-[#1b2c4a] font-intro">+40%</div>
      ...
      <Button 
        variant="outline" 
        className="w-full font-inter border-[#80c8f0] text-[#80c8f0] hover:bg-[#80c8f0] hover:text-white transition-colors"
      >
