-- Allow suppliers with active invitations to view basic RFX info including creator fields
-- This enables suppliers to see the creator email, name, and surname when viewing RFX invitations
